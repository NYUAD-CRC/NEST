...
def nnUNET(write_path, read_path, foldername):
    ...
    custom_env_vars= "nnUNet_preprocessed=./nnUNet_files/dataset_preprocessed nnUNet_results=./nnUNet_files/nnUNet_results nnUNet_raw=./nnUNet_files/nnUNet_raw"
    
    # cmd = "nnUNetv2_predict -i {} -o {} -d 101 -c 3d_fullres_0.125scale -f all".format(read_path, write_path)
    cmd = "nnUNetv2_predict -i {} -o {} -d 101 -c 3d_fullres_0.125scale -f all".format(read_path, write_path)
    final_cmd = "{} {}".format(custom_env_vars, cmd)
